    ...
    <div className="card-bordered group flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex flex-wrap gap-2 sm:flex-col sm:items-end sm:flex-nowrap">
        ...
        <button
          ...
          onClick={onReject}
          disabled={isApproving || isRejecting}
          className="inline-flex flex-1 items-center justify-center rounded-button border-2 border-red-500/20 bg-red-500/10 px-4 py-2.5 text-xs font-semibold text-red-700 shadow-soft transition-all duration-150 hover:bg-red-500/20 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 sm:w-32"
        >
          {isRejecting ? (
            <span className="flex items-center gap-1">
