...
export default function SearchBar({
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="group flex items-center gap-3 rounded-button border border-border-strong bg-paper px-4 py-3 shadow-soft transition-all duration-150 focus-within:border-primary focus-within:ring-4 focus-within:ring-primary/15">
        <svg
