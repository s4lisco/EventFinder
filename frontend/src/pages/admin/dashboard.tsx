...
export default function AdminDashboardPage() {
  ...
  return (
    <>
      <Head>
        <title>Admin Dashboard | The Urban Pulse</title>
      </Head>
      <div className="flex min-h-screen flex-col bg-surface">
        <header className="border-b border-border bg-white px-4 py-4 shadow-soft backdrop-blur-xl lg:px-8">
          ...
          <div className="mx-auto max-w-5xl px-4 py-6 lg:px-8">
            ...
            <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center gap-3">
                {loadingEvents ? (
                  ...
                  <div className="rounded-pill bg-secondary/20 px-4 py-2 font-body text-sm font-semibold text-primary shadow-soft">
            ...
            <div className="space-y-4">
              ...
              {!loadingEvents && events.length === 0 && (
                <div className="animate-slide-up rounded-card border-2 border-dashed border-border bg-white p-8 text-center shadow-soft">
                  <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-secondary/20">
                    <svg className="h-8 w-8 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </div>
                  <p className="font-sans text-lg font-bold text-text">All caught up!</p>
